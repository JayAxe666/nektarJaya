...
<test>
    ...
    <parameters>--npt 5 PararealDriver_Movement_fixed_3D_stacked_cylinders_curved_hdf5.xml</parameters>
    <processes>5</processes>
    <files>
        <file description="Session File">PararealDriver_Movement_fixed_3D_stacked_cylinders_curved_hdf5.xml</file>
