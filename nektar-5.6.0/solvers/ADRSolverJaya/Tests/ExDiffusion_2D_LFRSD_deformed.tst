...
<test>
    ...
    <files>
        <file description="Session File">ExDiffusion_2D_LFRSD_deformed.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
            <value variable="u" tolerance="1e-12">0.00146938</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-12">0.00970756</value>
        </metric>
    </metrics>
</test>
