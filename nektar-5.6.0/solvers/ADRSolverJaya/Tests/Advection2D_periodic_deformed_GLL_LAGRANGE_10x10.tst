...
<test>
    ...
    <parameters>Advection2D_periodic_deformed_GLL_LAGRANGE_10x10.xml</parameters>
    <files>
        <file description="Session File">Advection2D_periodic_deformed_GLL_LAGRANGE_10x10.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
