...
#define CODELET_OPTIM " -fno-schedule-insns -fno-web --param inline-unit-growth=1000 --param large-function-growth=1000"
...
#define FFTW_CC "/opt/cray/pe/craype/2.7.19/bin/cc -O3 -fomit-frame-pointer -malign-double -fstrict-aliasing -ffast-math -march=native"
